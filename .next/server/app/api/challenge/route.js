...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   GET: () => (/* binding */ GET)\n/* harmony export */ });\n/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! next/server */ \"(rsc)/./node_modules/next/dist/api/server.js\");\n/* harmony import */ var _lib_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/lib/auth */ \"(rsc)/./lib/auth.ts\");\n/* harmony import */ var _lib_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/lib/db */ \"(rsc)/./lib/db.ts\");\n\n\n\nasync function GET() {\n    const session = await (0,_lib_auth__WEBPACK_IMPORTED_MODULE_1__.getSession)();\n    if (!session) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: \"Unauthorized\"\n        }, {\n            status: 401\n        });\n    }\n    const user = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.user.findUnique({\n        where: {\n            id: session.userId\n        },\n        select: {\n            currentDay: true\n        }\n    });\n    if (!user) {\n        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n            error: \"User not found\"\n        }, {\n            status: 404\n        });\n    }\n    const challenges = await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.challenge.findMany({\n        orderBy: {\n            dayNumber: \"asc\"\n        }\n    });\n    const solvedDayNumbers = new Set((await _lib_db__WEBPACK_IMPORTED_MODULE_2__.prisma.submission.findMany({\n        where: {\n            userId: session.userId,\n            challengeId: {\n                not: null\n            }\n        },\n        select: {\n            challenge: {\n                select: {\n                    dayNumber: true\n                }\n            }\n        }\n    })).filter((s)=>s.challenge).map((s)=>s.challenge.dayNumber));\n    const maxUnlocked = user.currentDay;\n    const list = challenges.map((c)=>({\n            id: c.id,\n            dayNumber: c.dayNumber,\n            category: c.category,\n            difficulty: c.difficulty,\n            description: c.description,\n            industryNote: c.industryNote,\n            solved: solvedDayNumbers.has(c.dayNumber),\n            unlocked: c.dayNumber <= maxUnlocked\n        }));\n    return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({\n        challenges: list,\n        currentDay: user.currentDay\n    });\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/challenge/route.ts\n");
